      ...
      <main class="main">
        ...
        <section class="main__next-level next-level flex flex-row pt-10">
          ...
          >
            <img
              ...
              src="<?php echo get_template_directory_uri(); ?>/assets/pictures/Next_level.png"
              alt="Our podcasts"
              width="650"
              height="873"
            />
        ...
        <section class="main__host host flex flex-row">
          ...
          <div class="host__photo host-photo">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/pictures/Host.png" alt="Photo of the host" />
          </div>
        </section>
